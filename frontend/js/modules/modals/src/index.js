...
modal.addEventListener('show.bs.modal', function (event) {
    ...
    new ProductQtyInput();
    document.querySelector('#mm-30').classList.remove('mm-slideout');
    document.querySelector('#mm-30').classList.add('mm-page-inactive');
    ...
    if (discountPrice) {
        ...
        currentTarget.querySelector('.old-price').textContent = '';
    }
...
modal.addEventListener('hide.bs.modal', function (event) {
    document.querySelector('#mm-30').classList.remove('mm-page-inactive');
    document.querySelector('#mm-30').classList.add('mm-slideout');
});