	...
	plugins: [
		isProduction ? new PurgeCSSPlugin({
			paths: glob.sync([
				...
				`${current_working_dir}/html/about-us.html`
			]),
			keyframes: true
		}) : function() {}
	]
...
const frontend_folder_config = {
	...
	plugins: [
		...
		new MiniCssExtractPlugin({
			filename: `${working_dir_inverse_path}styles/css/about-us/about-us.css`,
		})
	]
};
const backend_folder_config = {
	...
	plugins: [
		...common_config.plugins,
		new MiniCssExtractPlugin({
			filename: '../../../../../static/styles/css/about-us/about-us.css',
		})
	]
};
